...
namespace Azusayumi.Core.GameLogic
{
    ...
    {
        public const int Pawn = 0, Knight = 1, Bishop = 2, Rook = 3, Queen = 4, King = 5, None = 6, Length = 6;
    }

    public static class Square
    {
        public const int A1 = 00, B1 = 01, C1 = 02, D1 = 03, E1 = 04, F1 = 05, G1 = 06, H1 = 07;
        public const int A2 = 08, B2 = 09, C2 = 10, D2 = 11, E2 = 12, F2 = 13, G2 = 14, H2 = 15;
        ...
        public const int None = 64, Length = 64;
